...
--
-- Table structure for table `t_server_config_historys_ice321`
--

DROP TABLE IF EXISTS `t_server_config_historys_ice321`;
CREATE TABLE `t_server_config_historys_ice321` (
  `ID` int(11) NOT NULL auto_increment,
  `CONFIGID` int(11) NOT NULL default '0',
  ...
  `REASON_SELECT` varchar(64) default NULL,
  PRIMARY KEY  (`ID`),
  KEY `IDX_CONFIGID` (`CONFIGID`)
) ENGINE=MyISAM DEFAULT CHARSET=gbk;
...
--
-- Table structure for table `t_server_configs_ice321`
--

DROP TABLE IF EXISTS `t_server_configs_ice321`;
CREATE TABLE `t_server_configs_ice321` (
  `ID` int(11) NOT NULL auto_increment,
...
--
-- Table structure for table `t_server_notifys_ice321`
--

DROP TABLE IF EXISTS `t_server_notifys_ice321`;
CREATE TABLE `t_server_notifys_ice321` (
  `ID` int(11) NOT NULL auto_increment,
  `TOPIC` varchar(100) default NULL,
  `SERVERID` varchar(400) default NULL,
  `OBJECTID` varchar(160) default NULL,
  `THREADID` int(11) unsigned default NULL,
  `COMMAND` varchar(240) default NULL,
  `RESULT` text,
  `POSTTIME` datetime default NULL,
  PRIMARY KEY  (`ID`),
  KEY `IDX_TOPIC` (`TOPIC`)
...
--
-- Table structure for table `t_server_patchs_ice321`
--

DROP TABLE IF EXISTS `t_server_patchs_ice321`;
CREATE TABLE `t_server_patchs_ice321` (
  `ID` int(11) NOT NULL auto_increment,
  `SERVER` varchar(100) default NULL,
  `TGZ` varchar(510) default NULL,
  `UPDATETEXT` text,
  ...
  `LASTUSER` varchar(100) default NULL,
  `REASON_SELECT` varchar(64) default NULL,
  `DOCUMENT_COMPLETE` varchar(6) default NULL,
  PRIMARY KEY  (`ID`),
  KEY `IDX_APP` (`SERVER`),
  KEY `IDX_APP_SERVERNAME` (`SERVER`)
) ENGINE=MyISAM DEFAULT CHARSET=gbk;
